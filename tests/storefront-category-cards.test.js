...
test("storefront category cards use full-bleed motion media", async () => {
  ...
  assert.match(source, /const WOMEN_CATEGORY_TRIAL_VIDEO_URL = "https:\/\/videos\.pexels\.com\/video-files\/7877138\/7877138-uhd_4096_2160_25fps\.mp4";/);
  ...
  assert.match(source, /const KIDS_CATEGORY_TRIAL_VIDEO_URL = "https:\/\/videos\.pexels\.com\/video-files\/8456205\/8456205-hd_1920_1080_25fps\.mp4";/);
