  ...
  const story = {
    ...
    metadata: {
      ...
      story_asset_snapshot: {
        ...
        templateKey: "m1_story_current", templateVersion: "v1", rendererBuild: "m1-story-audience-collection-v1-2026-07-24", generationId: "generation-10", checksum: "a".repeat(64),
      },
    },
  };
  ...
  const normalized = normalizeQueueRow({
    ...
    metadata: {
      ...
      story_asset_snapshot: {
        ...
        templateKey: "m1_story_current", templateVersion: "v1", rendererBuild: "m1-story-audience-collection-v1-2026-07-24", generationId: "generation-12", checksum: "b".repeat(64),
      },
    },
  });
  ...
  const story = {
    ...
    metadata: {
      ...
      story_asset_snapshot: {
        ...
        templateKey: "m1_story_current", templateVersion: "v1", rendererBuild: "m1-story-audience-collection-v1-2026-07-24", generationId: "generation-20", checksum: "c".repeat(64),
      },
    },
  };
