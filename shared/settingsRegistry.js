...
const definitions = [
  ...
  ["pos.business_day_start_hour", "pos", "number", 4, "Business day starts at", "اليوم المحاسبي يبدأ الساعة", "The hour the shop's day begins, on a 24-hour clock. The manager portal's day card runs from this hour to the same hour the next day — 4 means 04:00 to 04:00 — so a night that trades past midnight stays in one day instead of being cut in half at 00:00.", "الساعة اللي يبدأ عندها يوم المحل، بنظام 24 ساعة. كارت حسابات اليوم في بوابة المدير بيمشي من الساعة دي لنفس الساعة تاني يوم — يعني 4 معناها من 4 الفجر لـ 4 الفجر — فالليلة اللي بتعدي نص الليل تفضل في يوم واحد بدل ما تتقطع نصين عند 12.", { validation: { min: 0, max: 23, integer: true } }],
