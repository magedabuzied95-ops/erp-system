...
const definitions = [
  ...
  ["general.barcode_print_thermal_style", "general", "select", THERMAL_ARTWORK_DEFAULTS.style, "Thermal artwork style", "نمط صورة الثرمال", "Automatic measures how dark each product is and picks line art or halftone for it. Line art keeps the details, halftone simulates greys with dots, outline keeps the edges only, silhouette fills the shape solid.", "تلقائي يقيس درجة عتمة كل منتج ويختار له خطوط أو تدرج نقطي. خطوط تحافظ على التفاصيل، تدرج نقطي يحاكي الرمادي بالنقاط، حواف تبقي الحدود فقط، ظل يملأ الشكل بالكامل.", { options: [option("auto", "Automatic per product", "تلقائي حسب المنتج"), option("detail", "Line art", "خطوط"), option("halftone", "Halftone dots", "تدرج نقطي"), option("outline", "Outline only", "حواف فقط"), option("silhouette", "Solid silhouette", "ظل مصمت")], usedBy: ["Barcode Labels", "Products"] }],
