...
const definitions = [
  ...
  ["orders.shipping_provider", "shipping", "select", "manual", "Shipping provider", "شركة الشحن", "Default shipping provider.", "شركة الشحن الافتراضية.", { options: [option("manual", "Manual", "يدوي"), option("bosta", "Bosta", "بوسطة"), option("mylerz", "Mylerz", "مايلرز"), option("aramex", "Aramex", "أرامكس"), option("store_pickup", "Store pickup", "استلام من الفرع")], usedBy: ["Orders", "Shipping"] }],
  ...
  ["orders.aramex_api_key", "shipping", "secret", "", "Aramex API key", "مفتاح أرامكس", "Placeholder for Aramex integration.", "عنصر جاهز لتكامل أرامكس لاحقا.", { isSecret: true, placeholder: true, usedBy: ["Shipping"] }],
