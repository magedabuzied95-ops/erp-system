...
const definitions = [
  ...
  ["pos.shift_visibility_grace_hours", "pos", "number", 3, "Keep a closed drawer on the manager portal for", "بقاء الدرج المقفول في بوابة المدير", "Hours a closed shift keeps its sales on the manager portal's day card. An OPEN shift always keeps them, however long it has been running — this only decides how long after it closes. 0 hands the card straight back to the calendar day at midnight.", "عدد الساعات اللي الوردية المقفولة تفضل مبيعاتها ظاهرة فيها في كارت حسابات اليوم. الوردية المفتوحة بتفضل ظاهرة دايما مهما طالت — الرقم ده بيحدد المدة بعد ما تقفل بس. صفر يرجّع الكارت لليوم بالتقويم عند نص الليل.", { validation: { min: 0, max: 24 } }],
