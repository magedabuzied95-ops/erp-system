...
Failure of `/shop/product/*` compatibility is a **release blocker**, not optional SEO cleanup. → Full ownership-chain inspection scheduled at the PDP phase (first URL-touching surface).
