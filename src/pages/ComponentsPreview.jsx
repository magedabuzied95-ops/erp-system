...
export default function ComponentsPreview() {
  ...
  return <main className="components-preview m1-page" dir={language === "ar" ? "rtl" : "ltr"}>
    ...
    <div className="components-preview__content">
      <div className="components-preview__heading"><div><span>المرحلة الثالثة</span><h1>المكونات المشتركة</h1></div><Button variant="primary" icon={Plus} onClick={() => setModalOpen(true)}>عملية بيع جديدة</Button></div>
