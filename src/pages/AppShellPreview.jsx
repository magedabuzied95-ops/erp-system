  ...
  return <div className="shell-preview m1-page" dir={rtl?"rtl":"ltr"} data-language={language}>
    ...
    <div className="shell-stage">
      ...
      <main className="shell-content">
        ...
        <section className="shell-pagehead"><div><span>مركز التحكم التنفيذي</span><h1>صباح الخير، ماجد</h1></div><div><button className="m1-action-secondary">تصدير التقرير</button><button className="m1-action-primary">عملية بيع جديدة</button></div></section>
