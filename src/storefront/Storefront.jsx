...
const SUSPICIOUS_ARABIC_GLYPH_RE = /[ï؟½ï؟½ï؟½ï؟½]/;
...
const couponErrorText = (reason = "") => {
  ...
  return sfText(key, String(reason || "").trim() || sfText("storefront.checkout.couponErrors.invalid", "ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½"));
};
...
const normalizeAudienceValue = (value = "") => {
  ...
  if (["men", "man", "male", "mens", "ï؟½ï؟½ï؟½ï؟½ï؟½", "ï؟½ï؟½ï؟½ï؟½"].includes(normalized)) return "men";
  if (["women", "woman", "female", "ladies", "lady", "ï؟½ï؟½ï؟½ï؟½ï؟½", "ï؟½ï؟½ï؟½ï؟½", "ï؟½ï؟½ï؟½ï؟½ï؟½"].includes(normalized)) return "women";
  if (["kids", "kid", "children", "child", "boys", "girls", "ï؟½ï؟½ï؟½ï؟½ï؟½", "ï؟½ï؟½ï؟½ï؟½ï؟½"].includes(normalized)) return "kids";
  return "";
};
...
const getSuccessMessages = () => {
  ...
  return Array.isArray(messages) && messages.length ? messages : ["ط§ط®طھظٹط§ط± ظ…ظ…طھط§ط²", "ط·ظ„ط¨ظƒ ظٹطھظ… طھط¬ظ‡ظٹط²ظ‡ ط§ظ„ط¢ظ†", "ط§ط®طھظٹط§ط± ظ‚ظˆظٹ", "ط³ظ†ط¬ظ‡ط²ظ‡ ظ„ظƒ ط¨ط£ط³ط±ط¹ ظˆظ‚طھ"];
};

const getConversionTrustPoints = () => {
  const points = i18n.t("storefront.home.trustPoints", { returnObjects: true });
  return Array.isArray(points) && points.length ? points : ["ط¯ظپط¹ ط¢ظ…ظ†", "طھط¨ط¯ظٹظ„ ط³ظ‡ظ„", "طµظˆط± ط­ظ‚ظٹظ‚ظٹط©", "ط´ط­ظ† ط³ط±ظٹط¹"];
};

const homeSellingBadges = [
  { labelAr: "ط´ط­ظ† ط³ط±ظٹط¹", labelEn: "Fast shipping", icon: Truck },
  { labelAr: "ط§ط³طھط¨ط¯ط§ظ„ ط®ظ„ط§ظ„ 14 ظٹظˆظ…ظ‹ط§", labelEn: "14-day exchange", icon: RefreshCcw },
  { labelAr: "ط¯ظپط¹ ط¢ظ…ظ†", labelEn: "Secure payment", icon: ShieldCheck },
  { labelAr: "طµظˆط± ط­ظ‚ظٹظ‚ظٹط©", labelEn: "Real photos", icon: Camera },
];
...
const MANUAL_CITY_AREA = "ط§ظ„ط§ط®طھظٹط§ط± ط§ظ„ظٹط¯ظˆظٹ";
...
const DEFAULT_STOREFRONT_PAYMENT_SETTINGS = repairArabicMojibakeDeep({
  ...
  shippingConfirmation: {
    enabled: true,
    amount: 75,
    label: "ط§ظ„ظ…ط¨ظ„ط؛ ط§ظ„ظ…ط·ظ„ظˆط¨ طھط­ظˆظٹظ„ظ‡ ط§ظ„ط¢ظ†",
  },
});
const MANUAL_CITY_AREA_LABEL = "ط§ظ„ط§ط®طھظٹط§ط± ط§ظ„ظٹط¯ظˆظٹ";
...
const getSearchPlaceholders = () => {
  ...
  return Array.isArray(values) && values.length ? values : ["ط§ط¨ط­ط« ط¹ظ† Jordan 4...", "ط§ط¨ط­ط« ط¹ظ† Sneakers...", "ط§ط¨ط­ط« ط¨ط§ظ„ظ…ظ‚ط§ط³ 42...", "ط§ط¨ط­ط« ط¨ط§ط³ظ… ط§ظ„ط¨ط±ط§ظ†ط¯...", "ط§ط¨ط­ط« ط¨ظ€ SKU..."];
};

const getTrendingSearches = () => {
  const values = i18n.t("storefront.search.trending", { returnObjects: true });
  return Array.isArray(values) && values.length ? values : ["Jordan 4", "Sneakers", "ظ…ظ‚ط§ط³ 42", "Mirror Original", "Adidas", "ط±ط¬ط§ظ„ظٹ ط£ط³ظˆط¯"];
};
...
const getSearchFallbackSections = () => {
  ...
  return sections && typeof sections === "object" && !Array.isArray(sections)
    ? sections
    : {
      categories: ["ط±ط¬ط§ظ„ظٹ", "ط­ط±ظٹظ…ظٹ", "ط£ط·ظپط§ظ„", "ط¹ط±ظˆط¶", "ط¢ط®ط± ظ‚ط·ط¹ط©"],
...
const featuredCategoryDefinitions = [
  {
    ...
    headlineAr: "ط£ط­ط¯ط« ط£ط­ط°ظٹط© ط§ظ„ط±ط¬ط§ظ„",
    subtitleEn: "Fresh sneakers, daily picks, and standout sizes for every look.",
    subtitleAr: "ط³ظ†ظٹظƒط±ط² ط¬ط¯ظٹط¯ط©طŒ ط§ط®طھظٹط§ط±ط§طھ ظٹظˆظ…ظٹط©طŒ ظˆظ…ظ‚ط§ط³ط§طھ ظ…ظ…ظٹط²ط© ظ„ظƒظ„ ط¥ط·ظ„ط§ظ„ط©.",
    query: "Jordan 4 Nike Shox Air Force Adidas Campus ط±ط¬ط§ظ„ظٹ",
  ...
  },
  {
    ...
    headlineAr: "ظ…ط¬ظ…ظˆط¹ط© ط§ظ„ط­ط±ظٹظ…ظٹ ط§ظ„ط¬ط¯ظٹط¯ط©",
    subtitleEn: "Soft colors, bold silhouettes, and everyday favorites in one edit.",
    subtitleAr: "ط£ظ„ظˆط§ظ† ظ†ط§ط¹ظ…ط©طŒ ظ‚طµط§طھ ط¬ط±ظٹط¦ط©طŒ ظˆظ…ظپط¶ظ„ط§طھ ظٹظˆظ…ظٹط© ظپظٹ ط§ط®طھظٹط§ط± ظˆط§ط­ط¯.",
    query: "Nike Adidas Jordan ط­ط±ظٹظ…ظٹ",
  ...
  },
  {
    ...
    headlineAr: "ط£ط³ط§ط³ظٹط§طھ ط§ظ„ط£ط·ظپط§ظ„",
    subtitleEn: "Built for school, play and movement.",
    subtitleAr: "ظ…طµظ…ظ…ط© ظ„ظ„ظ…ط¯ط±ط³ط© ظˆط§ظ„ظ„ط¹ط¨ ظˆط§ظ„ط­ط±ظƒط©.",
    query: "kids children school play ط£ط·ظپط§ظ„",
  ...
  },
  {
    ...
    headlineAr: "ط¹ط±ظˆط¶ ط§ظ„ظ…ظˆط³ظ…",
    subtitleEn: "Selected discounts and high-value picks for a limited time.",
    subtitleAr: "ط®طµظˆظ…ط§طھ ظ…ط®طھط§ط±ط© ظˆظ‚ط·ط¹ ط¹ط§ظ„ظٹط© ط§ظ„ظ‚ظٹظ…ط© ظ„ظپطھط±ط© ظ…ط­ط¯ظˆط¯ط©.",
    query: "offers sale discount ط¹ط±ظˆط¶",
  ...
  },
  {
    ...
    headlineAr: "ط§ط®طھظٹط§ط±ط§طھ ظƒط±ظˆظƒط³",
    subtitleEn: "Easy comfort, summer colors, and quick everyday pairs.",
    subtitleAr: "ط±ط§ط­ط© ط³ظ‡ظ„ط©طŒ ط£ظ„ظˆط§ظ† طµظٹظپظٹط©طŒ ظˆظ‚ط·ط¹ ظٹظˆظ…ظٹط© ط®ظپظٹظپط©.",
    query: "crocs crocband classic clog slides ظƒط±ظˆظƒط³",
  ...
  },
  {
    id: "last-sizes",
    labelEn: "Last Sizes",
    labelAr: "ط¢ط®ط± ط§ظ„ظ…ظ‚ط§ط³ط§طھ",
    headlineEn: "Last Sizes",
    headlineAr: "ط¢ط®ط± ط§ظ„ظ…ظ‚ط§ط³ط§طھ",
    subtitleEn: "Limited pairs with final sizes before they disappear.",
    subtitleAr: "ط£ط²ظˆط§ط¬ ظ…ط­ط¯ظˆط¯ط© ط¨ط§ظ„ظ…ظ‚ط§ط³ط§طھ ط§ظ„ط£ط®ظٹط±ط© ظ‚ط¨ظ„ ظ†ظپط§ط¯ظ‡ط§.",
    query: "last sizes final size ط¢ط®ط± ط§ظ„ظ…ظ‚ط§ط³ط§طھ",
...
const mainHomeCategoryCards = [
  {
    ...
    titleAr: "ط±ط¬ط§ظ„ظٹ",
    titleEn: "Men",
    subtitleAr: "ط£ط­ط¯ط« Nike ظˆ Adidas ظˆ Jordan",
  ...
  },
  {
    ...
    titleAr: "ط­ط±ظٹظ…ظٹ",
    titleEn: "Women",
    subtitleAr: "ط±ط§ط­ط© ظˆط£ظ†ط§ظ‚ط© ظ„ظƒظ„ ظٹظˆظ…",
  ...
  },
  {
    ...
    titleAr: "ط£ط·ظپط§ظ„",
    titleEn: "Kids",
    subtitleAr: "ظ…ظ†ط§ط³ط¨ ظ„ظ„ظ…ط¯ط±ط³ط© ظˆط§ظ„ظ„ط¹ط¨ ظˆط§ظ„ط­ط±ظƒط©",
    subtitleEn: "Built for school, play and movement",
    href: "/shop/products?gender=kids",
    test: (product, text) => productAudienceValues(product).includes("kids") || /kids?|children|child|\?{3,5}/i.test(text),
    icon: Baby,
  },
  {
    ...
    titleAr: "ط¹ط±ظˆط¶",
    titleEn: "Offers",
    subtitleAr: "ط¹ط±ظˆط¶ ط§ظ„ظ…ظˆط³ظ…",
  ...
  },
  {
    ...
    titleAr: "ظƒط±ظˆظƒط³",
    titleEn: "Crocs",
    subtitleAr: "ط±ط§ط­ط© ط³ظ‡ظ„ط© ظ„ظƒظ„ ظٹظˆظ…",
  ...
  {
    id: "last-sizes",
    titleAr: "ط¢ط®ط± ط§ظ„ظ…ظ‚ط§ط³ط§طھ",
    titleEn: "Last Sizes",
    subtitleAr: "ظ‚ط·ط¹ ظ…ط­ط¯ظˆط¯ط© ظ‚ط¨ظ„ ظ…ط§ طھط®طھظپظٹ",
            ...
            >
              ...
              <div className={`relative z-10 flex min-h-[300px] flex-col justify-end p-7 md:min-h-0 md:p-10 lg:p-12 ${isRtl ? "text-right" : "text-left"} ${reverse ? "md:order-2" : ""}`}>
                <div className="mb-4 w-fit rounded-full border border-white/15 bg-white/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.22em] text-[#f8e7b3] backdrop-blur">
                  {isRtl ? "ط§ط®طھظٹط§ط± ظ…ظ†ط³ظ‚" : "Curated edit"}
                </div>
                ...
                <span className="mt-7 inline-flex min-h-12 w-fit items-center justify-center gap-2 rounded-full bg-white px-6 text-sm font-black text-stone-950 shadow-[0_16px_34px_rgba(0,0,0,0.26)] transition group-hover:bg-[#f8e7b3] group-hover:shadow-[0_18px_42px_rgba(248,231,179,0.26)] md:min-h-14 md:px-8">
                  {isRtl ? "طھط³ظˆظ‚ ط§ظ„ط¢ظ†" : sfText("storefront.common.shopNow")}
...
function HomePage(props) {
  ...
  return (
    <div className="sf-page pb-[calc(var(--mobile-bottom-nav-height,76px)+env(safe-area-inset-bottom)+1.5rem)] md:pb-0">
      ...
      <HomeProductSection title={normalizeLanguage(lang) === "ar" ? "ط§ظ„ط£ظƒط«ط± ط·ظ„ط¨ظ‹ط§" : "Trending"} subtitle={normalizeLanguage(lang) === "ar" ? "ط§ط®طھظٹط§ط±ط§طھ ط±ط§ط¦ط¬ط© ظ…ط¹ ط£ط­ط¯ط« ط§ظ„ظ…ظ†طھط¬ط§طھ ظƒط®ظٹط§ط± ط¨ط¯ظٹظ„." : "Popular picks, with newest products as fallback."} viewAllTo="/shop/products?sort=trending" loading={loading || storefrontHome.loading} products={homeSections.trending} railType="trending" tone="trending" {...props} />
      <Reviews />
      <HomeBrandsSection />
...
function LastPieceFinder({ open, onClose }) {
  ...
  const title = step === "categories" ? "ط¢ط®ط± ظ‚ط·ط¹ط©" : step === "sizes" ? "ط§ط®طھط± ط§ظ„ظ…ظ‚ط§ط³" : `${selectedCategory} / ${selectedSize}`;
  ...
  return (
    <section className="sf-reveal mx-auto max-w-[1200px] px-4 py-2 md:py-4">
      <div className="mb-2 flex items-end justify-between gap-3 text-right md:mb-4 md:gap-4">
        <div className="min-w-0">
          <div className="mb-0.5 text-[9.5px] font-black uppercase tracking-[0.15em] text-[#7c3aed] dark:text-[#d8b4fe] md:mb-1 md:text-[11px] md:tracking-[0.18em]">{t("storefront.common.shopNow", "طھط³ظˆظ‚ ط§ظ„ط¢ظ†")}</div>
        ...
        <Link to="/shop/products" className="mb-0.5 inline-flex min-h-8 shrink-0 items-center justify-center rounded-full border border-stone-200 bg-white px-3 py-1.5 text-[11px] font-black text-stone-700 shadow-[0_10px_26px_rgba(39,20,75,0.07)] transition hover:-translate-y-0.5 hover:border-[#7c3aed]/50 hover:text-[#6d28d9] active:scale-[0.98] md:mb-1 md:min-h-10 md:px-5 md:py-2 md:text-xs dark:border-white/10 dark:bg-white/5 dark:text-stone-200">
          {t("common.viewAll", "ط¹ط±ط¶ ط§ظ„ظƒظ„")}
        </Link>
      </div>
...
function MiniRailEmpty() {
  ...
  return (
    <div className="rounded-[1.5rem] border border-[#8b5cf6]/18 bg-[linear-gradient(180deg,rgba(18,18,28,0.96),rgba(7,10,20,0.94))] p-6 text-center text-stone-50 shadow-[0_18px_45px_rgba(0,0,0,0.45),inset_0_1px_0_rgba(255,255,255,0.04)] backdrop-blur-xl">
      ...
      <h3 className="mt-3 text-lg font-black text-stone-50">{t("storefront.products.emptyRailTitle", "ظ„ط§ طھظˆط¬ط¯ ظ…ظ†طھط¬ط§طھ ط¨ط¹ط¯")}</h3>
  ...
  return (
    <section className="scroll-mt-28">
      <div className="mb-2.5 flex items-end justify-between gap-2 md:mb-3 md:gap-3">
        <SectionIntro eyebrow={t("storefront.filters.gender", "ï؟½ï؟½ï؟½ï؟½ï؟½")} title={t("storefront.products.chooseWearer", "ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½")} subtitle={t("storefront.products.chooseWearerSubtitle", "ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")} compact />
      </div>
        ...
        {options.map((option) => {
          ...
          return (
            ...
            >
              ...
              <span className="mt-0.5 block text-[9.5px] font-bold leading-3 text-stone-500 dark:text-stone-400 md:mt-1 md:text-xs md:leading-5">{t("storefront.products.chooseAndViewTypes", "ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")}</span>
            </button>
          );
        })}
      </div>
        ...
        {loading ? <ProductTypeSkeleton /> : options.map((option) => {
          ...
          return (
            ...
            >
              ...
              {Number.isFinite(Number(count)) ? <span className="mt-0.5 block text-[9.5px] font-bold leading-3 text-stone-500 dark:text-stone-400 md:mt-1 md:text-[11px] md:leading-4">{t("storefront.products.productCount", "{{count}} ï؟½ï؟½ï؟½ï؟½", { count })}</span> : null}
            </button>
          );
        })}
      </div>
      {!loading && !options.length ? <EmptyState title={t("storefront.products.noTypesForCategory", "ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½")} text={t("storefront.products.goBackChooseAnother", "ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½")} /> : null}
    </div>
  );
}
  ...
  return (
    <div className={`mb-2.5 rounded-[0.9rem] border border-stone-200 bg-white p-2 shadow-[0_10px_24px_rgba(39,20,75,0.05)] dark:border-white/10 dark:bg-[#0b1020] md:mb-4 md:rounded-[1.35rem] md:p-3 ${disabled ? "opacity-55" : ""}`}>
      <div className="mb-1.5 flex items-center justify-between gap-2 md:mb-2 md:gap-3">
        <div>
          <p className="text-[8.5px] font-black uppercase tracking-[0.14em] text-[#7c3aed] md:text-[10px] md:tracking-[0.18em]">{t("storefront.filters.sizeFilter", "ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")}</p>
          <h3 className="text-xs font-black md:text-sm">{t("storefront.filters.availableSize", "ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")}</h3>
        </div>
        {selectedSize ? (
          <button type="button" onClick={() => onSelect("")} className="rounded-full bg-stone-100 px-2 py-1 text-[10.5px] font-black text-stone-600 transition hover:bg-stone-950 hover:text-white dark:bg-white/8 dark:text-stone-200 md:px-3 md:py-1.5 md:text-xs">
            {t("storefront.filters.showAllSizes", "ï؟½ï؟½ï؟½ ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")}
          </button>
        ) : null}
      </div>
      <div className="sf-scroll flex gap-1.5 overflow-x-auto pb-0.5 md:gap-2 md:pb-1">
        ...
        {!sizes.length ? <span className="rounded-full border border-dashed border-stone-200 px-2.5 py-1.5 text-[10.5px] font-bold text-stone-400 dark:border-white/10 md:px-4 md:py-2 md:text-xs">{t("storefront.filters.sizesAppearAfterType", "ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")}</span> : null}
      </div>
    </div>
  );
}
    ...
    <div className="mb-5 hidden md:block">
      <div className="mb-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.22em] text-[#7c3aed]">{t("storefront.filters.curatedFilters", "ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")}</p>
            <h2 className="text-sm font-black text-stone-950 dark:text-white">{t("storefront.filters.quickPremium", "ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ Premium")}</h2>
          </div>
        </div>
        {activeFilterCount ? (
          <Link
          ...
          >
            {t("storefront.filters.clearFilters", "ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")}
          </Link>
        ) : null}
      </div>
...
function MobileFilterTrigger({ activeFilterCount = 0, onOpen }) {
  ...
  return (
    ...
    >
      <SlidersHorizontal className="h-4 w-4" />
      <span>{t("storefront.filters.filters", "ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")}</span>
...
function MobileFilterDrawer({ open, sections, lang, draftFilters, setDraftFilters, onClose, onApply, onReset }) {
  ...
  return (
    <div className="sf-mobile-filter-drawer fixed inset-0 z-50 md:hidden" role="dialog" aria-modal="true">
      <button type="button" className="absolute inset-0 bg-stone-950/55 backdrop-blur-sm" onClick={onClose} aria-label={t("storefront.filters.closeFilters", "ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")} />
      <div className="absolute inset-x-0 bottom-0 max-h-[82dvh] overflow-hidden rounded-t-[1.5rem] border border-white/10 bg-[linear-gradient(180deg,#101426_0%,#070b16_100%)] text-white shadow-[0_-24px_70px_rgba(0,0,0,0.42)]">
        ...
        <div className="flex items-center justify-between gap-3 border-b border-white/10 px-3.5 py-3">
          <div>
            <p className="text-[9px] font-black uppercase tracking-[0.18em] text-[#d8b4fe]">{t("storefront.filters.premiumFilters", "ï؟½ï؟½ï؟½ï؟½ï؟½ Premium")}</p>
            <h2 className="text-base font-black">{t("storefront.filters.chooseWhatFits", "ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")}</h2>
          </div>
          <button type="button" onClick={onClose} className="grid h-9 w-9 place-items-center rounded-full border border-white/10 bg-white/5 transition active:scale-95" aria-label={t("common.close", "ï؟½ï؟½ï؟½ï؟½ï؟½")}>
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        <div className="absolute inset-x-0 bottom-0 flex gap-2 border-t border-white/10 bg-[#070b16]/92 px-3 py-2.5 pb-[calc(env(safe-area-inset-bottom)+0.625rem)] backdrop-blur-xl">
          <button type="button" onClick={onApply} className="flex-1 rounded-xl bg-gradient-to-l from-[#7c3aed] to-[#111827] px-4 py-2.5 text-sm font-black text-white shadow-[0_14px_34px_rgba(124,58,237,0.32)] active:scale-[0.98]">
            {t("storefront.filters.applyFilters", "ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")}
          </button>
...
function Header({ cartCount, wishlistCount, onCart, onAddToCart, effectiveTheme, onToggleTheme }) {
  ...
  const announcementItems = [
    { label: t("storefront.header.announcements.fastShipping", "ط´ط­ظ† ط³ط±ظٹط¹ ط¯ط§ط®ظ„ ظ…طµط±"), icon: <Truck className="h-3.5 w-3.5" /> },
    { label: t("storefront.header.announcements.exchange", "14-day exchange"), icon: <RefreshCcw className="h-3.5 w-3.5" /> },
    { label: t("storefront.header.announcements.cod", "ط§ظ„ط¯ظپط¹ ط¹ظ†ط¯ ط§ظ„ط§ط³طھظ„ط§ظ…"), icon: <PackageCheck className="h-3.5 w-3.5" /> },
    { label: t("storefront.header.announcements.premium", "Mirror Premium products"), icon: <Sparkles className="h-3.5 w-3.5" /> },
    { label: t("storefront.header.announcements.todayDeals", "ط®طµظˆظ…ط§طھ ط§ظ„ظٹظˆظ…"), icon: <BadgePercent className="h-3.5 w-3.5" /> },
  ];
  const utilityItems = [
    { label: "ظˆط§طھط³ط§ط¨", to: "https://wa.me/", icon: <MessageCircle className="h-3.5 w-3.5" />, external: true },
    { label: t("storefront.header.trackOrder", "طھطھط¨ط¹ ط§ظ„ط·ظ„ط¨"), to: "/shop/track", icon: <PackageSearch className="h-3.5 w-3.5" /> },
    { label: t("storefront.header.wishlist", "ط§ظ„ظ…ظپط¶ظ„ط©"), to: "/shop/wishlist", icon: <Heart className="h-3.5 w-3.5" /> },
    { label: t("storefront.header.account", "ط§ظ„ط­ط³ط§ط¨"), to: "/shop/account", icon: <User className="h-3.5 w-3.5" /> },
  ];
  const navItems = [
    [t("storefront.nav.categories", "Categories"), "/shop/products"],
    [t("storefront.nav.sale", "Sale"), "/shop/sale"],
    [t("storefront.nav.new", "ط§ظ„ط¬ط¯ظٹط¯"), "/shop/products?sort=new"],
    [t("storefront.nav.men", "ط±ط¬ط§ظ„ظٹ"), "/shop/products?q=ط±ط¬ط§ظ„ظٹ"],
    [t("storefront.nav.women", "ط­ط±ظٹظ…ظٹ"), "/shop/products?q=ط­ط±ظٹظ…ظٹ"],
    [t("storefront.nav.kids", "ط£ط·ظپط§ظ„"), "/shop/products?q=ط£ط·ظپط§ظ„"],
  ];
  ...
  const handleImageSearch = async (event) => {
    ...
    if (file) {
      ...
      const label = file.name.replace(/\.[^.]+$/, "") || "ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½";
      if (visualPreviewUrlRef.current) URL.revokeObjectURL(visualPreviewUrlRef.current);
      const previewUrl = URL.createObjectURL(file);
      visualPreviewUrlRef.current = previewUrl;
      setSearch(`ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½: ${label}`);
      setSuggestions([]);
      ...
      try {
        ...
        setVisualSearch({
          ...
          message: products.length ? "" : data.message || "ï؟½ï؟½ ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½",
          error: "",
          previewUrl,
          fileName: file.name,
        });
    ...
    >
      ...
      <div className="sf-main-row sf-header-main mx-auto grid max-w-7xl grid-cols-[auto_1fr_auto] items-center gap-3 px-4 py-2.5 transition-all duration-300 md:grid-cols-[auto_auto_minmax(320px,520px)_auto] md:gap-5 md:py-3">
        ...
        <div className="flex items-center justify-end gap-2">
          ...
          <HeaderAction to="/shop/wishlist" label={t("storefront.header.wishlist", "ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")} count={wishlistCount} icon={<Heart className="h-5 w-5" />} className="sf-secondary-action hidden md:grid" />
          <HeaderAction to="/shop/account" label={t("storefront.header.account", "ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")} icon={<User className="h-5 w-5" />} className="sf-secondary-action hidden md:grid" />
          <div className="sf-secondary-action relative hidden md:block">
            <button onClick={toggleNotifications} className="sf-header-action" aria-label={t("storefront.header.notifications", "ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")}>
      ...
      {menuOpen ? (
        <div className="grid gap-2 border-t border-stone-200 bg-white/96 px-4 py-4 text-sm font-bold backdrop-blur dark:border-white/10 dark:bg-[#0b1020]/96 md:hidden">
          {[t("storefront.nav.home", "ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½"), t("storefront.nav.categories", "ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½"), t("storefront.nav.sale", "ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½"), t("storefront.nav.new", "ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½"), t("storefront.nav.men", "ï؟½ï؟½ï؟½ï؟½ï؟½"), t("storefront.nav.women", "ï؟½ï؟½ï؟½ï؟½ï؟½"), t("storefront.nav.sizeGuide", "ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½"), t("storefront.nav.returns", "ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")].map((label, index) => (
            <Link key={label} to={["/shop", "/shop/products", "/shop/sale", "/shop/products?sort=new", "/shop/products?q=ï؟½ï؟½ï؟½ï؟½ï؟½", "/shop/products?q=ï؟½ï؟½ï؟½ï؟½ï؟½", "/shop/size-guide", "/shop/returns"][index]} onClick={() => setMenuOpen(false)} className="rounded-2xl px-3 py-3 transition hover:bg-stone-100 dark:hover:bg-white/5 active:scale-[0.98]">
              {label}
            </Link>
          ))}
        </div>
...
function SearchQuickSections({ value, loading, suggestions, chips, activeIndex, onPickTerm, onPickProduct, trendingSearches = [], searchFallbackSections = {} }) {
  ...
  return (
    <div className="grid gap-3">
      {query ? (
        <div>
          <div className="mb-2 flex items-center justify-between px-1">
            <span className="text-xs font-black text-stone-500 dark:text-stone-400">ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½</span>
            {loading ? <span className="text-[11px] font-bold text-[#7c3aed]">ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½...</span> : null}
          </div>
      ...
      {!query ? (
        <>
          <SearchChips title="ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½" items={trendingSearches} onPick={onPickTerm} />
          {chips.length ? <SearchChips title="ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½" items={chips.slice(0, 6)} onPick={onPickTerm} /> : null}
          <div className="grid gap-2 sm:grid-cols-3">
            <SearchQuickCard title="ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½" items={searchFallbackSections.categories || []} onPick={onPickTerm} />
            <SearchQuickCard title="ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½" items={searchFallbackSections.brands || []} onPick={onPickTerm} />
            <SearchQuickCard title="ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½" items={searchFallbackSections.styles || []} onPick={onPickTerm} />
          </div>
        </>
      ) : null}
    </div>
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="truncate text-xs font-bold text-stone-500 dark:text-stone-400">
          {[product.category, product.brand, product.style, product.grade].filter(Boolean).join(" / ") || product.sizes?.slice(0, 4).join(" / ") || "ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½"}
        </div>
      </div>
    ...
    <article ref={cardRef} style={eagerImage ? undefined : { contentVisibility: "auto", containIntrinsicSize: "240px 400px" }} onClick={openDetails} onMouseEnter={requestDetailPrefetch} onTouchStart={requestDetailPrefetch} className={`sf-product-card group/product relative flex h-full min-h-0 transform-gpu cursor-pointer flex-col overflow-hidden rounded-[1.2rem] border border-white/70 bg-[linear-gradient(145deg,rgba(255,255,255,0.98),rgba(250,248,244,0.94)_48%,rgba(245,241,234,0.84))] shadow-[0_10px_26px_rgba(39,20,75,0.07),inset_0_1px_0_rgba(255,255,255,0.8)] ring-1 ring-stone-200/55 transition-[transform,box-shadow,border-color,background-color] duration-200 ease-out hover:-translate-y-1 hover:border-[#a78bfa]/38 hover:ring-[#7c3aed]/22 hover:shadow-[0_18px_44px_rgba(39,20,75,0.12),0_0_0_1px_rgba(124,58,237,0.08)_inset] md:rounded-[1.55rem] dark:border-white/[0.08] dark:bg-[linear-gradient(145deg,rgba(17,24,39,0.95),rgba(11,16,32,0.93)_52%,rgba(8,13,25,0.98))] dark:ring-white/[0.05] dark:shadow-[0_14px_34px_rgba(0,0,0,0.24),inset_0_1px_0_rgba(255,255,255,0.05)] dark:hover:border-[#a78bfa]/24 dark:hover:shadow-[0_20px_54px_rgba(0,0,0,0.32),0_0_24px_rgba(124,58,237,0.10)] ${featured ? "md:shadow-[0_18px_52px_rgba(109,40,217,0.12)]" : ""}`}>
      ...
      <div className={`relative overflow-visible bg-[radial-gradient(circle_at_50%_42%,rgba(167,139,250,0.12),transparent_28%),linear-gradient(180deg,#fbfaf7_0%,#eee7dc_100%)] md:p-3 dark:bg-[radial-gradient(circle_at_50%_42%,rgba(167,139,250,0.10),transparent_28%),linear-gradient(180deg,#101426_0%,#0b1020_100%)] ${densityClasses.image}`}>
        ...
        <button
          ...
          aria-label={t("storefront.header.wishlist", "ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")}
        >
          ...
          {product.low_stock ? <span className="absolute bottom-2 right-2 z-20 inline-flex h-5 items-center rounded-full border border-amber-200 bg-amber-50/95 px-2 text-[9px] font-black leading-none text-amber-800 shadow-sm backdrop-blur md:bottom-auto md:left-12 md:right-auto md:top-2.5 md:h-6 md:px-2.5 md:text-[10px] dark:border-amber-300/20 dark:bg-amber-400/10 dark:text-amber-100">{t("storefront.products.onlyLeft", "ï؟½ï؟½ï؟½ï؟½ {{count}} ï؟½ï؟½ï؟½", { count: product.total_stock })}</span> : null}
      </div>
        ...
        <div className={`sf-scroll flex flex-nowrap overflow-x-auto pb-0.5 md:mt-3 md:min-h-12 md:flex-wrap md:content-start md:gap-1.5 md:overflow-hidden ${densityClasses.sizes}`}>
          ...
          {!visibleSizes.length ? (
            <span className="inline-flex h-6 shrink-0 items-center rounded-full border border-stone-300/90 bg-white px-2 text-[9px] font-bold leading-none text-stone-500 shadow-sm md:text-[10px] dark:border-white/10 dark:bg-white/5 dark:text-stone-500">{t("storefront.products.oneSize", "ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½")}</span>
          ) : null}
        </div>
        <button
          type="button"
          ...
          aria-label={canQuickAdd ? t("storefront.cart.addToCart", "ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½") : t("storefront.products.unavailable", "ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½")}
        >
          <ShoppingCart className="h-[18px] w-[18px] text-white" />
          {canQuickAdd ? t("storefront.cart.addToCart", "ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½") : t("storefront.products.unavailable", "ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½")}
        </button>
      </div>
      {variantSheetOpen ? (
  ...
  return createPortal(
    <div className="sf-product-variant-sheet fixed inset-0 z-[90] pointer-events-auto md:hidden" role="dialog" aria-modal="true">
      <button
        ...
        aria-label={t("common.close", "ï؟½ï؟½ï؟½ï؟½ï؟½")}
      />
      <section
      ...
      >
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#d8b4fe]">{t("storefront.products.chooseSize", "ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")}</p>
        ...
        {colorGroups.length > 1 ? (
          <div className="mt-4">
            <div className="mb-2 text-[11px] font-black text-white/50">{t("storefront.products.color", "ï؟½ï؟½ï؟½")}</div>
        ...
        <div className="mt-4">
          <div className="mb-2 text-[11px] font-black text-white/50">{t("storefront.products.size", "ï؟½ï؟½ï؟½ï؟½")}</div>
        ...
        <div className="mt-4 flex items-center justify-between gap-3 rounded-2xl border border-white/10 bg-white/[0.045] p-2">
          ...
          <div className="text-center">
            <div className="text-[10px] font-black uppercase tracking-[0.16em] text-white/35">{t("storefront.cart.quantity", "ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")}</div>
        ...
        >
          ...
          {t("storefront.cart.addToCart", "ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½")}
        </button>
      </section>
    </div>,
    document.body
...
const supportHref = (orderNumber = "") => {
  const text = orderNumber ? sfText("storefront.support.orderHelpMessage", "ï؟½ï؟½ï؟½ï؟½ï؟½ا، ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ {{orderNumber}}", { orderNumber }) : sfText("storefront.support.generalHelpMessage");
    ...
    <div className="fixed inset-0 z-50">
      ...
      <aside dir="rtl" className="sf-cart-drawer absolute inset-x-0 bottom-0 flex max-h-[94dvh] min-h-[72dvh] w-full min-w-0 flex-col overflow-hidden rounded-t-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(15,18,33,0.98),rgba(7,10,20,0.98))] text-white shadow-[0_-28px_80px_rgba(0,0,0,0.48),inset_0_1px_0_rgba(255,255,255,0.06)] backdrop-blur-2xl md:inset-y-0 md:end-0 md:start-auto md:max-h-none md:min-h-0 md:w-[28rem] md:rounded-s-[2rem] md:rounded-tr-none">
        <div className="flex shrink-0 items-center justify-between border-b border-white/10 bg-white/[0.035] px-4 pb-3 pt-[calc(1rem+env(safe-area-inset-top))] sm:px-5">
          <div className="min-w-0">
            <p className="text-xs font-black text-[#c4b5fd]">{cart.length ? sfText("storefront.products.productCount", "{{count}} ï؟½ï؟½ï؟½ï؟½", { count: cart.length }) : "ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½"}</p>
            <h2 className="mt-1 truncate text-2xl font-black text-white">ï؟½ï؟½ï؟½ï؟½ï؟½</h2>
          </div>
        ...
        <div className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden px-4 py-4 sm:px-5">
          {!cart.length ? (
            <EmptyState title="ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½" text="ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½ï؟½" actionLabel="ï؟½ï؟½ï؟½ï؟½ ï؟½ï؟½ï؟½ï؟½" />
          ) : (
    ...
    <article dir="rtl" className="sf-cart-row w-full min-w-0 rounded-[1.35rem] border border-white/10 bg-white/[0.055] p-3 text-right text-white shadow-[0_16px_42px_rgba(0,0,0,0.24),inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-xl">
      <div className="flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0 flex-1 self-stretch">
          ...
          <p className="mt-1 inline-flex max-w-full rounded-full border border-white/10 bg-white/[0.055] px-2 py-1 text-xs font-bold text-white/58">{item.color || sfText("storefront.products.color", "ï؟½ï؟½ï؟½ï؟½ï؟½")} / {item.size || sfText("storefront.products.size", "ï؟½ï؟½ï؟½ï؟½ï؟½ï؟½")}</p>
