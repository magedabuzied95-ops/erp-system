        ...
        <div className="flex w-full items-center gap-3 md:gap-6" dir="rtl">
          <div className="flex shrink-0 items-center gap-2 md:gap-4">
            ...
            <Link to="/shop" className="sf-header-logo group inline-flex shrink-0 items-center text-stone-950 transition hover:text-[#6d28d9] dark:text-white" aria-label={brandName || "MONE"}>
              <span
                className="sf-header-logo-chip grid h-[82px] w-[82px] place-items-center overflow-hidden rounded-full border border-white/85 bg-transparent text-base font-black tracking-[0.18em] text-white transition group-hover:scale-[1.01] md:h-[104px] md:w-[104px]"
                style={{ clipPath: "circle(50% at 50% 50%)", transform: "translateZ(0)", backfaceVisibility: "hidden" }}
              >
                {brandLogoUrl ? <img src={resolveProductImageUrl(brandLogoUrl)} alt={brandName} className="h-[120%] w-[120%] object-cover object-center" style={{ imageRendering: "auto", transform: "translateZ(0)", backfaceVisibility: "hidden" }} loading="lazy" decoding="async" width="104" height="104" /> : brandInitials}
              </span>
            </Link>
          </div>
