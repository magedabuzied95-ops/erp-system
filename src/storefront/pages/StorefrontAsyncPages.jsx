...
export function WishlistPageRoute({ wishlist, toggleWishlist, onAddToCart, helpers, components }) {
  ...
  return (
    <section className="mx-auto w-full max-w-7xl px-3 py-6 sm:px-4 md:px-6 md:py-10">
      <div className="rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,#050505_0%,#101010_45%,#151515_100%)] p-4 shadow-[0_28px_72px_rgba(0,0,0,0.32)] backdrop-blur-xl md:p-6">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div className="min-w-0">
          ...
          <div className="w-fit rounded-full border border-white/10 bg-white/[0.06] px-4 py-2 text-sm font-black text-white/80 shadow-[0_12px_28px_rgba(0,0,0,0.18)]">
        ...
        {wishlistCount ? (
          <>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              <div className="flex items-start gap-4 rounded-[1.5rem] border border-white/10 bg-white/[0.05] p-5 text-start shadow-[0_18px_42px_rgba(0,0,0,0.20)] ring-1 ring-white/[0.025] backdrop-blur-xl">
...
function PremiumCartContent({ cart, updateCart, removeFromCart, helpers, components }) {
    ...
    return (
      <section className="sf-cart-empty mt-5 rounded-[2rem] border border-white/10 bg-[radial-gradient(circle_at_top,rgba(212,175,55,0.12),transparent_42%),linear-gradient(180deg,#050505_0%,#0d0d0d_48%,#141414_100%)] p-5 text-center text-white shadow-[0_28px_80px_rgba(0,0,0,0.32)] md:p-8">
        <div className="mx-auto max-w-md">
          ...
          <EmptyState title="ط§ظ„ط³ظ„ط© ظپط§ط±ط؛ط©" text="ط§ط®طھط± ظ…ظ†طھط¬ظ‹ط§ ط£ظˆظ„ظ‹ط§ ط«ظ… ط£ظƒظ…ظ„ ط§ظ„ط¯ظپط¹" actionLabel="طھط³ظˆظ‚ ط§ظ„ط¢ظ†" />
          <Link to="/products" className="mt-5 inline-flex min-h-12 items-center justify-center rounded-full bg-[linear-gradient(135deg,#d4af37,#e5c158)] px-6 py-3 text-sm font-black text-[#151515] shadow-[0_18px_42px_rgba(212,175,55,0.24)] transition hover:-translate-y-0.5">
            {sfText("storefront.common.continueShopping", "طھط³ظˆظ‚ ط§ظ„ط¢ظ†")}
          </Link>
        </div>
      </section>
    );
  ...
  return (
    <div dir="rtl" className="sf-cart-shell mt-5 space-y-5">
      <div className="sf-cart-hero rounded-[2rem] border border-white/10 bg-[radial-gradient(circle_at_top_right,rgba(212,175,55,0.16),transparent_38%),linear-gradient(180deg,#050505_0%,#0d0d0d_48%,#141414_100%)] p-4 text-white shadow-[0_28px_80px_rgba(0,0,0,0.32)] md:p-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-black md:text-3xl">{sfText("storefront.header.cart", "السلة")}</h2>
            <p className="mt-2 text-sm font-bold leading-7 text-white/58">راجع المنتجات والكميات قبل الانتقال إلى الدفع.</p>
          </div>
          <div className="grid gap-2 sm:grid-cols-3">
            <div className="rounded-[1.35rem] border border-white/10 bg-white/[0.05] px-4 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
              <div className="text-[11px] font-black text-white/50">عدد المنتجات</div>
              <div className="mt-1 text-xl font-black text-white">{cartLines}</div>
            </div>
            <div className="rounded-[1.35rem] border border-white/10 bg-white/[0.05] px-4 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
              <div className="text-[11px] font-black text-white/50">إجمالي القطع</div>
            ...
            <div className="rounded-[1.35rem] border border-[#d4af37]/20 bg-[#d4af37]/10 px-4 py-3 shadow-[0_14px_32px_rgba(212,175,55,0.12)]">
              <div className="text-[11px] font-black text-[#f3d77a]/75">الإجمالي الحالي</div>
      ...
      <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_340px]">
        <div className="space-y-3">
          {cart.map((item) => (
            <div key={item.lineId} dir="rtl" className="sf-cart-item-card flex gap-3 rounded-[1.75rem] border border-white/8 bg-[radial-gradient(circle_at_top_right,rgba(212,175,55,0.08),transparent_28%),linear-gradient(180deg,#050505_0%,#101010_45%,#151515_100%)] p-3 text-right text-white shadow-[0_18px_50px_rgba(0,0,0,0.28),inset_0_1px_0_rgba(255,255,255,0.04)] md:p-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-3 grid gap-3 md:grid-cols-[auto_1fr] md:items-end">
                  ...
                  <div className="rounded-[1.2rem] border border-[#d4af37]/18 bg-[#d4af37]/10 px-4 py-3 text-right shadow-[0_14px_30px_rgba(212,175,55,0.10)]">
                    <div className="text-[11px] font-black text-[#f3d77a]/80">إجمالي هذا المنتج</div>
        ...
        <aside dir="rtl" className="sf-cart-summary-card sf-storefront-card sf-checkout-summary h-max rounded-[1.9rem] border border-white/8 bg-[radial-gradient(circle_at_top,rgba(212,175,55,0.14),transparent_38%),linear-gradient(180deg,#050505_0%,#101010_45%,#151515_100%)] p-5 text-right text-white shadow-[0_24px_70px_rgba(0,0,0,0.34),inset_0_1px_0_rgba(255,255,255,0.05)] lg:sticky lg:top-4">
          <div className="mb-4">
            <div className="text-xs font-black uppercase tracking-[0.2em] text-[#f3d77a]/80">Cart Totals</div>
            <h2 className="mt-2 text-2xl font-black text-white">ظ…ظ„ط®طµ ط§ظ„ط·ظ„ط¨</h2>
            <p className="mt-2 text-sm font-bold leading-7 text-white/54">الإجمالي النهائي والشحن يظهران لك بوضوح قبل إنهاء الطلب.</p>
          </div>
          <SummaryRow rtl dark label="ط§ظ„ظ…ظ†طھط¬ط§طھ" value={money(subtotal)} />
          <SummaryRow rtl dark label="ط§ظ„ط´ط­ظ† ط§ظ„طھظ‚ط¯ظٹط±ظٹ" value={money(0)} />
          <SummaryRow rtl dark label="ط§ظ„ط¥ط¬ظ…ط§ظ„ظٹ" value={money(subtotal)} strong />
          <div className="mt-4 rounded-[1.25rem] border border-white/10 bg-white/[0.04] p-4 text-sm font-bold leading-7 text-white/62">
            الشحن النهائي يتم احتسابه في الـ checkout حسب العنوان وطريقة التوصيل.
          </div>
          <Link to="/checkout" className="mt-5 block rounded-full bg-[linear-gradient(135deg,#d4af37,#e5c158)] px-5 py-4 text-center font-black text-[#151515] shadow-[0_18px_42px_rgba(212,175,55,0.26)] transition hover:-translate-y-0.5 hover:shadow-[0_24px_54px_rgba(212,175,55,0.32)]">ط¥طھظ…ط§ظ… ط§ظ„ط´ط±ط§ط،</Link>
          <div className="mt-4 grid gap-2 text-xs font-black text-white/56">
            <span className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-2 text-center">مراجعة العنوان والدفع في الخطوة التالية</span>
            <span className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-2 text-center">يمكن تعديل الكمية من هنا قبل المتابعة</span>
          </div>
        </aside>
      </div>
    </div>
