  ...
  return (
    <div className="rounded-[34px] border border-white/10 bg-zinc-950/90 p-5 shadow-2xl shadow-black/10">
      ...
      <div className="mt-4 grid gap-2 md:grid-cols-2 xl:grid-cols-3">
        ...
        <button type="button" onClick={regeneratePortalLink} disabled={portalTokenBusy} className="inline-flex min-h-11 items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-4 text-sm font-semibold text-white transition hover:bg-white/10 disabled:opacity-60">
