...
export default function Customer360Drawer({
  ...
  // Restock requests live in the shared RestockRequestsPanel (also mounted in the POS).
          ...
          {activeTab === "products" ? (
            <div className="space-y-3">
              ...
              <RestockRequestsPanel
                phone={restockPhone}
                customerId={resolvedCustomerId || customer?.customer_id || customer?.id || null}
                onRequestPick={onRequestRestockPick}
                restockPick={restockPick}
                onClearRestockPick={onClearRestockPick}
              />
            </div>
          ) : null}
