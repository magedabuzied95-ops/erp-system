            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <button
                  ...
                  disabled={historyLoading}
                  className="inline-flex h-10 items-center gap-2 rounded-2xl border border-rose-300/20 bg-rose-400/10 px-3 text-sm font-black text-rose-100 transition hover:bg-rose-400/15 disabled:opacity-50"
                >
