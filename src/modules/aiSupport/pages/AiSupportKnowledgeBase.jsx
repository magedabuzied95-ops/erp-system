                ...
                <label key={field.key} className={field.type === "input" ? "block" : "block md:col-span-2"}>
                  ...
                  {field.type === "input" ? (
                    ...
                    <textarea
                      ...
                      onChange={(event) => updateField(field.key, event.target.value)}
                      placeholder={field.placeholder}
                      className="w-full resize-y rounded-2xl border border-[var(--border)] bg-[var(--card)] px-4 py-3 text-right text-sm font-semibold leading-7 text-[var(--text)] outline-none transition focus:border-[var(--primary)] focus:ring-4 focus:ring-[var(--primary)]/10"
                    />
                  )}
                </label>
              ))}
