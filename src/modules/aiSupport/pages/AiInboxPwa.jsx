...
function ProductSheet({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/35" onClick={onClose}>
      <div
        className="absolute inset-x-0 bottom-0 max-h-[84vh] rounded-t-[28px] bg-white shadow-[0_-16px_40px_rgba(15,23,42,0.18)]"
      ...
      >
        ...
        <div className="space-y-4 px-4 pb-[max(1rem,env(safe-area-inset-bottom))] pt-4">
          <div className="flex items-start justify-between gap-3">
            <div>
              <h3 className="text-lg font-semibold text-slate-900">Send Product</h3>
