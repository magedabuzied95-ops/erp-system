                ...
                sessions.map((session) => (
                  ...
                  >
                    ...
                    <div className="mt-3 flex flex-wrap gap-2 text-xs font-semibold text-slate-300">
                      <span className="rounded-full bg-white/5 px-2.5 py-1">{tt("managerPortal.labels.items")}: {formatNumber(session.item_count || 0)}</span>
                      <span className="rounded-full bg-white/5 px-2.5 py-1">{tt("managerPortal.labels.totalDifferences")}: {formatNumber(session.difference_total || 0)}</span>
                    </div>
                  </button>
                ))
              ) : (
