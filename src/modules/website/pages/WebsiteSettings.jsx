...
const EGYPT_GOVERNORATES = [
  ["Cairo", "ط§ظ„ظ‚ط§ظ‡ط±ط©"],
  ["Giza", "ط§ظ„ط¬ظٹط²ط©"],
  ["Alexandria", "ط§ظ„ط¥ط³ظƒظ†ط¯ط±ظٹط©"],
  ["Dakahlia", "ط§ظ„ط¯ظ‚ظ‡ظ„ظٹط©"],
  ["Red Sea", "ط§ظ„ط¨ط­ط± ط§ظ„ط£ط­ظ…ط±"],
  ["Beheira", "ط§ظ„ط¨ط­ظٹط±ط©"],
  ["Fayoum", "ط§ظ„ظپظٹظˆظ…"],
  ["Gharbia", "ط§ظ„ط؛ط±ط¨ظٹط©"],
  ["Ismailia", "ط§ظ„ط¥ط³ظ…ط§ط¹ظٹظ„ظٹط©"],
  ["Menofia", "ط§ظ„ظ…ظ†ظˆظپظٹط©"],
  ["Minya", "ط§ظ„ظ…ظ†ظٹط§"],
  ["Qalyubia", "ط§ظ„ظ‚ظ„ظٹظˆط¨ظٹط©"],
  ["New Valley", "ط§ظ„ظˆط§ط¯ظٹ ط§ظ„ط¬ط¯ظٹط¯"],
  ["Suez", "ط§ظ„ط³ظˆظٹط³"],
  ["Aswan", "ط£ط³ظˆط§ظ†"],
  ["Assiut", "ط£ط³ظٹظˆط·"],
  ["Beni Suef", "ط¨ظ†ظٹ ط³ظˆظٹظپ"],
  ["Port Said", "ط¨ظˆط±ط³ط¹ظٹط¯"],
  ["Damietta", "ط¯ظ…ظٹط§ط·"],
  ["Sharqia", "ط§ظ„ط´ط±ظ‚ظٹط©"],
  ["South Sinai", "ط¬ظ†ظˆط¨ ط³ظٹظ†ط§ط،"],
  ["Kafr El Sheikh", "ظƒظپط± ط§ظ„ط´ظٹط®"],
  ["Matrouh", "ظ…ط·ط±ظˆط­"],
  ["Luxor", "ط§ظ„ط£ظ‚طµط±"],
  ["Qena", "ظ‚ظ†ط§"],
  ["North Sinai", "ط´ظ…ط§ظ„ ط³ظٹظ†ط§ط،"],
  ["Sohag", "ط³ظˆظ‡ط§ط¬"],
];
...
const shippingCopy = {
  ...
  ar: {
    ...
    subtitle: "طھط­ظƒظ… ظپظٹ ط£ط³ط¹ط§ط± ط§ظ„ظ…طھط¬ط± ظˆط§ظ„ط´ط­ظ† ظˆط§ظ„ط¯ظپط¹ ظ…ظ† ظˆط­ط¯ط© ط¥ط¯ط§ط±ط© ظˆط§ط­ط¯ط©.",
    openStorefront: "ظپطھط­ ط§ظ„ظ…طھط¬ط±",
    overview: "ظ†ط¸ط±ط© ط¹ط§ظ…ط©",
    shipping: "ط§ظ„ط´ط­ظ†",
    pricingTitle: "ط¥ط¹ط¯ط§ط¯ط§طھ ط£ط³ط¹ط§ط± ط§ظ„ظ…طھط¬ط±",
    pricingText: "ط£ط³ط¹ط§ط± ط§ظ„ظ…ظ‚ط§ط±ظ†ط© طھط¸ظ‡ط± ظپظٹ ط§ظ„ظ…طھط¬ط± ظپظ‚ط· ظˆظ„ط§ طھط¤ط«ط± ط¹ظ„ظ‰ ط§ظ„ظƒط§ط´ظٹط± ط£ظˆ ط§ظ„ظپظˆط§طھظٹط± ط£ظˆ ط§ظ„طھظ‚ط§ط±ظٹط±.",
    save: "ط­ظپط¸",
    saving: "ط¬ط§ط± ط§ظ„ط­ظپط¸...",
    saveAll: "ط­ظپط¸ ط¥ط¹ط¯ط§ط¯ط§طھ ط§ظ„ظ…ظˆظ‚ط¹",
    unsaved: "طھط؛ظٹظٹط±ط§طھ ط؛ظٹط± ظ…ط­ظپظˆط¸ط©",
    saved: "طھظ… ط­ظپط¸ ط§ظ„ط¥ط¹ط¯ط§ط¯ط§طھ",
    loadError: "طھط¹ط°ط± طھط­ظ…ظٹظ„ ط¥ط¹ط¯ط§ط¯ط§طھ ط§ظ„ظ…ظˆظ‚ط¹",
    saveError: "طھط¹ط°ط± ط­ظپط¸ ط§ظ„ط¥ط¹ط¯ط§ط¯ط§طھ",
    defaultPrice: "ط§ظ„ط³ط¹ط± ط§ظ„ط§ظپطھط±ط§ط¶ظٹ",
    activeZones: "ط§ظ„ظ…ظ†ط§ط·ظ‚ ط§ظ„ظ†ط´ط·ط©",
    codZones: "ظ…ظ†ط§ط·ظ‚ ط§ظ„ط¯ظپط¹ ط¹ظ†ط¯ ط§ظ„ط§ط³طھظ„ط§ظ…",
    proofZones: "ظ…ظ†ط§ط·ظ‚ ط¥ط«ط¨ط§طھ ط§ظ„ط¯ظپط¹",
    shippingTitle: "ظ…ظ†ط§ط·ظ‚ ط§ظ„ط´ط­ظ†",
    shippingText: "ظٹطھظ… ط­ط³ط§ط¨ ط§ظ„ط´ط­ظ† ط­ط³ط¨ ط§ظ„ظ…ظ†ط·ظ‚ط© ط£ظˆظ„ط§ظ‹ ط«ظ… ط§ظ„ظ…ط¯ظٹظ†ط©/ط§ظ„ظ…ط±ظƒط² ط«ظ… ط§ظ„ظ…ط­ط§ظپط¸ط© ط«ظ… ط§ظ„ط³ط¹ط± ط§ظ„ط§ظپطھط±ط§ط¶ظٹ.",
    search: "ط§ط¨ط­ط« ط¨ط§ظ„ظ…ط­ط§ظپط¸ط© ط£ظˆ ط§ظ„ظ…ط¯ظٹظ†ط© ط£ظˆ ط§ظ„ظ…ظ†ط·ظ‚ط© ط£ظˆ ط§ظ„ط´ط±ظƒط©",
    allGovs: "ظƒظ„ ط§ظ„ظ…ط­ط§ظپط¸ط§طھ",
    addZone: "ط¥ط¶ط§ظپط© ظ…ظ†ط·ظ‚ط©",
    addGovernorates: "ط¥ط¶ط§ظپط© ظƒظ„ ظ…ط­ط§ظپط¸ط§طھ ظ…طµط±",
    import: "ط§ط³طھظٹط±ط§ط¯",
    export: "طھطµط¯ظٹط±",
    selected: "ظ…ط­ط¯ط¯",
    bulkPrice: "طھط¹ط¯ظٹظ„ ط³ط¹ط± ط§ظ„ظ…ط­ط¯ط¯",
    bulkCodOn: "طھظپط¹ظٹظ„ ط§ظ„ط¯ظپط¹ ط¹ظ†ط¯ ط§ظ„ط§ط³طھظ„ط§ظ…",
    bulkCodOff: "ط¥ظٹظ‚ط§ظپ ط§ظ„ط¯ظپط¹ ط¹ظ†ط¯ ط§ظ„ط§ط³طھظ„ط§ظ…",
    bulkProofOn: "ظٹطھط·ظ„ط¨ ط¥ط«ط¨ط§طھ ط¯ظپط¹",
    bulkProofOff: "ظ„ط§ ظٹطھط·ظ„ط¨ ط¥ط«ط¨ط§طھ ط¯ظپط¹",
    bulkEta: "طھط¹ط¯ظٹظ„ ظ…ط¯ط© ط§ظ„طھظˆطµظٹظ„",
    deleteSelected: "ط­ط°ظپ ط§ظ„ظ…ط­ط¯ط¯",
    governorate: "ط§ظ„ظ…ط­ط§ظپط¸ط©",
    city: "ط§ظ„ظ…ط¯ظٹظ†ط© / ط§ظ„ظ…ط±ظƒط²",
    area: "ط§ظ„ظ…ظ†ط·ظ‚ط© / ط§ظ„ط­ظٹ",
    price: "ط§ظ„ط³ط¹ط±",
    cod: "ط§ظ„ط¯ظپط¹ ط¹ظ†ط¯ ط§ظ„ط§ط³طھظ„ط§ظ…",
    proof: "ط¥ط«ط¨ط§طھ ط§ظ„ط¯ظپط¹",
    eta: "ظ…ط¯ط© ط§ظ„طھظˆطµظٹظ„",
    provider: "ط´ط±ظƒط© ط§ظ„ط´ط­ظ†",
    freeThreshold: "ط´ط­ظ† ظ…ط¬ط§ظ†ظٹ ظپظˆظ‚",
    minCod: "ط­ط¯ ط£ط¯ظ†ظ‰ ظ„ظ„ط¯ظپط¹ ط¹ظ†ط¯ ط§ظ„ط§ط³طھظ„ط§ظ…",
    active: "ظ†ط´ط·",
    actions: "ط¥ط¬ط±ط§ط،ط§طھ",
    noZones: "ظ„ط§ طھظˆط¬ط¯ ظ…ظ†ط§ط·ظ‚ ط´ط­ظ† ظ…ط·ط§ط¨ظ‚ط© ظ„ظ„ظپظ„ط§طھط±.",
    loading: "ط¬ط§ط± طھط­ظ…ظٹظ„ ط¥ط¹ط¯ط§ط¯ط§طھ ط§ظ„ظ…ظˆظ‚ط¹...",
    importFailed: "ظ…ظ„ظپ ط§ظ„ط§ط³طھظٹط±ط§ط¯ ظٹط¬ط¨ ط£ظ† ظٹط­طھظˆظٹ ط¹ظ„ظ‰ ظ‚ط§ط¦ظ…ط© JSON ظ„ظ„ظ…ظ†ط§ط·ظ‚.",
    seeded: "طھظ…طھ ط¥ط¶ط§ظپط© ظ…ط­ط§ظپط¸ط§طھ ظ…طµط±",
    noMissing: "ظƒظ„ ظ…ط­ط§ظپط¸ط§طھ ظ…طµط± ظ…ظˆط¬ظˆط¯ط© ط¨ط§ظ„ظپط¹ظ„",
    quickCreate: "ط¥ط¶ط§ظپط© ط³ط±ظٹط¹ط©",
    governorateOnly: "ظ…ط­ط§ظپط¸ط© ظپظ‚ط·",
    cityLevel: "ظ…ط­ط§ظپط¸ط© + ظ…ط¯ظٹظ†ط©/ظ…ط±ظƒط²",
    areaLevel: "ظ…ط­ط§ظپط¸ط© + ظ…ط¯ظٹظ†ط© + ظ…ظ†ط·ظ‚ط©/ط­ظٹ",
  },
};
    ...
    <div className="space-y-5 pb-24" dir={isArabic ? "rtl" : "ltr"}>
      <header className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-xl shadow-[var(--shadow)]">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <a href="/" className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-[var(--primary)] px-4 text-sm font-black text-white shadow-lg">
...
function OverviewTab({ copy, pricing, markPricing }) {
  const cards = [
    { title: "Website status", value: "Online", description: "Public storefront is available at /.", icon: ShieldCheck, tone: "emerald" },
