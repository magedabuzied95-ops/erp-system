    ...
    <div className="space-y-5 pb-24" dir={isArabic ? "rtl" : "ltr"}>
      <header className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-xl shadow-[var(--shadow)]">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <a href="/shop" className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-[var(--primary)] px-4 text-sm font-black text-white shadow-lg">
...
function OverviewTab({ copy, pricing, markPricing }) {
  const cards = [
    { title: "Website status", value: "Online", description: "Public storefront is available at /shop.", icon: ShieldCheck, tone: "emerald" },
