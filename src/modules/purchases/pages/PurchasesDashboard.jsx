            ...
            <label className="block md:col-span-2 xl:col-span-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="h-[var(--control-height-md)] w-full rounded-[var(--radius-control)] border border-emerald-400/20 bg-zinc-950/80 py-2 pe-3 ps-9 text-sm font-semibold text-white outline-none transition placeholder:text-zinc-600 focus:border-emerald-400/50 focus:shadow-[0_0_0_3px_rgba(16,185,129,0.12)]"
                />
              </div>
            </label>
                  ...
                  >
                    ...
                    <div className="relative flex justify-center">
                      <button
                        ...
                        className="inline-flex h-[var(--control-height-sm)] w-8 items-center justify-center rounded-[var(--radius-control)] border border-white/10 bg-white/[0.035] text-zinc-400 transition hover:border-white/20 hover:bg-white/[0.07] hover:text-white"
...
function MenuButton({ icon, label, onClick, danger = false, disabled = false, title }) {
  return (
    <button
      ...
      disabled={disabled}
      title={title}
      className={`flex w-full items-center gap-2 rounded-[var(--radius-control)] px-3 py-2 text-left text-sm hover:bg-white/5 disabled:cursor-not-allowed disabled:opacity-45 ${danger ? "text-rose-300" : "text-zinc-200"}`}
    >
      {icon}
      {label}
    </button>
