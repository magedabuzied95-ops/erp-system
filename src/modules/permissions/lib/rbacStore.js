...
const MODULE_SEARCH_METADATA = {
  Dashboard: { arabicTitle: "ظ„ظˆط­ط© ط§ظ„طھط­ظƒظ…", aliases: ["Home", "Overview", "ط¯ط§ط´ط¨ظˆط±ط¯", "ط§ظ„ط±ط¦ظٹط³ظٹط©"], keywords: ["kpi", "summary", "analytics"] },
  Employees: { arabicTitle: "ط§ظ„ظ…ظˆط¸ظپظˆظ†", aliases: ["Employee", "HR", "Staff", "ظ…ظˆط¸ظپ", "ط§ظ„ظ…ظˆط¸ظپظٹظ†"], keywords: ["payroll", "attendance", "commissions", "ظ…ط±طھط¨ط§طھ", "ط­ط¶ظˆط±", "ط¹ظ…ظˆظ„ط§طھ"] },
  Notifications: { arabicTitle: "ط§ظ„ط¥ط´ط¹ط§ط±ط§طھ", aliases: ["Alerts", "طھظ†ط¨ظٹظ‡ط§طھ"], keywords: ["messages", "system alerts"] },
  Workspace: { arabicTitle: "ظ…ط³ط§ط­ط© ط§ظ„ط¹ظ…ظ„", aliases: ["Company workspace", "ظ…ط³ط§ط­ط©"], keywords: ["company", "tenant", "organization"] },
  Products: { arabicTitle: "ط§ظ„ظ…ظ†طھط¬ط§طھ", aliases: ["Product", "Catalog", "Items", "ظ…ظ†طھط¬", "ط£طµظ†ط§ظپ"], keywords: ["sku", "stock", "variants", "barcode", "ظ…ط®ط²ظˆظ†"] },
  "Add Product": { arabicTitle: "ط¥ط¶ط§ظپط© ظ…ظ†طھط¬", aliases: ["Create product", "New product", "ظ…ظ†طھط¬ ط¬ط¯ظٹط¯"], keywords: ["catalog", "sku", "create"] },
  Orders: { arabicTitle: "ط§ظ„ط·ظ„ط¨ط§طھ", aliases: ["Order", "Invoices", "Sales orders", "ط·ظ„ط¨", "ظپط§طھظˆط±ط©"], keywords: ["sales", "receipts", "checkout", "ظ…ط¨ظٹط¹ط§طھ"] },
  "POS PRO": { arabicTitle: "ظ†ظ‚ط·ط© ط§ظ„ط¨ظٹط¹", aliases: ["POS", "Point of sale", "Cashier", "Terminal", "ظƒط§ط´ظٹط±"], keywords: ["checkout", "receipt", "ط¨ظٹط¹"] },
  Customers: { arabicTitle: "ط§ظ„ط¹ظ…ظ„ط§ط،", aliases: ["Customer", "CRM", "Clients", "ط¹ظ…ظٹظ„"], keywords: ["loyalty", "wallet", "contacts"] },
  Purchases: { arabicTitle: "ط§ظ„ظ…ط´طھط±ظٹط§طھ", aliases: ["Purchase", "Procurement", "ط´ط±ط§ط،"], keywords: ["suppliers", "stock in", "reorder"] },
  Suppliers: { arabicTitle: "ط§ظ„ظ…ظˆط±ط¯ظˆظ†", aliases: ["Supplier", "Vendors", "ظ…ظˆط±ط¯"], keywords: ["purchases", "procurement"] },
  Inventory: { arabicTitle: "ط§ظ„ظ…ط®ط²ظˆظ†", aliases: ["Stock", "Inventory control", "ظ…ط®ط²ظ†"], keywords: ["products", "warehouses", "transfers"] },
  Warehouses: { arabicTitle: "ط§ظ„ظ…ط®ط§ط²ظ†", aliases: ["Warehouse", "Stores", "Storage", "ظ…ط®ط²ظ†"], keywords: ["inventory", "stock", "branches"] },
  Branches: { arabicTitle: "ط§ظ„ظپط±ظˆط¹", aliases: ["Branch", "Branches", "Store branches", "Branch network", "ظپط±ط¹", "ط§ظ„ظپط±ظˆط¹", "ط§ظ„ط´ط¨ظƒط©", "ط§ظ„ظپط±ظˆط¹ ط§ظ„ط±ط¦ظٹط³ظٹط©"], keywords: ["stores", "locations", "branch network", "bra", "ط´ط¨ظƒط© ط§ظ„ظپط±ظˆط¹", "ظ…ظˆط§ظ‚ط¹"] },
  "Stock Transfers": { arabicTitle: "ظ†ظ‚ظ„ ط§ظ„ظ…ط®ط²ظˆظ†", aliases: ["Transfers", "Inventory transfers", "طھط­ظˆظٹظ„ ظ…ط®ط²ظˆظ†"], keywords: ["warehouse", "branch", "stock movement"] },
  Accounting: { arabicTitle: "ط§ظ„ظ…ط­ط§ط³ط¨ط©", aliases: ["Accounts", "Finance ledger", "ظ…ط­ط§ط³ط¨ط©"], keywords: ["journal", "treasury", "cash"] },
  Expenses: { arabicTitle: "ط§ظ„ظ…طµط§ط±ظٹظپ", aliases: ["Expense", "Costs", "Spending", "ظ…طµط±ظˆظپ", "ظ†ظپظ‚ط§طھ"], keywords: ["advances", "finance", "payments", "ط³ظ„ظپ"] },
  Payroll: { arabicTitle: "ط§ظ„ظ…ط±طھط¨ط§طھ", aliases: ["Salaries", "Salary", "Payroll calculator", "ظ…ط±طھط¨ط§طھ", "ط±ظˆط§طھط¨", "ظ…ط±طھط¨", "ط±ط§طھط¨"], keywords: ["employees", "attendance deductions", "penalties", "ط®طµظˆظ…ط§طھ", "ط¬ط²ط§ط،ط§طھ"] },
  "Attendance Center": { arabicTitle: "ظ…ط±ظƒط² ط§ظ„ط­ط¶ظˆط±", aliases: ["Attendance", "Time attendance", "QR attendance", "ط­ط¶ظˆط±", "ط§ظ†طµط±ط§ظپ"], keywords: ["qr", "late", "absence", "missing hours", "ط؛ظٹط§ط¨", "طھط£ط®ظٹط±"] },
  Reports: { arabicTitle: "ط§ظ„طھظ‚ط§ط±ظٹط±", aliases: ["Report", "ERP reports", "طھظ‚ط§ط±ظٹط±"], keywords: ["analytics", "export", "pdf", "excel"] },
  Marketing: { arabicTitle: "ط§ظ„طھط³ظˆظٹظ‚", aliases: ["Marketing dashboard", "Campaign marketing", "طھط³ظˆظٹظ‚"], keywords: ["posts", "campaigns", "social"] },
  "AI Marketing Center": { arabicTitle: "ظ…ط±ظƒط² ط§ظ„طھط³ظˆظٹظ‚ ط¨ط§ظ„ط°ظƒط§ط، ط§ظ„ط§طµط·ظ†ط§ط¹ظٹ", aliases: ["AI marketing", "Marketing AI", "ط°ظƒط§ط، طھط³ظˆظٹظ‚ظٹ"], keywords: ["campaigns", "automation", "content"] },
  "Social Posts": { arabicTitle: "ظ…ظ†ط´ظˆط±ط§طھ ط§ظ„طھظˆط§طµظ„", aliases: ["Posts", "Social media", "ظ…ظ†ط´ظˆط±ط§طھ"], keywords: ["facebook", "instagram", "content"] },
  Storefront: { arabicTitle: "ط§ظ„ظ…طھط¬ط±", aliases: ["Website", "Shop", "Online store", "ظ…طھط¬ط±"], keywords: ["ecommerce", "storefront"] },
  "Website Orders": { arabicTitle: "ط·ظ„ط¨ط§طھ ط§ظ„ظ…ظˆظ‚ط¹", aliases: ["Online orders", "Website sales", "ط·ظ„ط¨ط§طھ ط§ظ„ظ…طھط¬ط±"], keywords: ["storefront", "ecommerce"] },
  "Website Settings": { arabicTitle: "ط¥ط¹ط¯ط§ط¯ط§طھ ط§ظ„ظ…ظˆظ‚ط¹", aliases: ["Store settings", "Shop settings", "ط§ط¹ط¯ط§ط¯ط§طھ ط§ظ„ظ…طھط¬ط±"], keywords: ["website", "storefront"] },
  Company: { arabicTitle: "ط§ظ„ط´ط±ظƒط©", aliases: ["Company settings", "Preferences", "ط´ط±ظƒط©"], keywords: ["settings", "tenant", "profile"] },
  Permissions: { arabicTitle: "ط§ظ„طµظ„ط§ط­ظٹط§طھ", aliases: ["Roles permissions", "Access control", "طµظ„ط§ط­ظٹط§طھ"], keywords: ["rbac", "roles", "users", "security"] },
  Users: { arabicTitle: "ط§ظ„ظ…ط³طھط®ط¯ظ…ظˆظ†", aliases: ["User", "System users", "ظ…ط³طھط®ط¯ظ…"], keywords: ["roles", "permissions", "login"] },
  Tenants: { arabicTitle: "ط§ظ„ظ…ط³طھط£ط¬ط±ظˆظ†", aliases: ["Tenant", "Companies", "SaaS tenants", "ظ…ط³طھط£ط¬ط±"], keywords: ["admin", "billing", "subscriptions"] },
};
...
const RAW_SIDEBAR_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "ط§ظ„ط¬ط±ط¯", to: "/inventory/count", permission: "inventory.view", icon: ClipboardList },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Expenses", to: "/expenses", permission: "expenses.view", icon: ReceiptText, keywords: "Expenses expense costs spending ط§ظ„ظ…طµط§ط±ظٹظپ ظ…طµط§ط±ظٹظپ ط§ظ„ظ†ظپظ‚ط§طھ" },
    ],
  },
  {
    title: "Employees",
  ...
  },
  {
    title: "WEBSITE",
    items: [
      { label: "Storefront", to: "/", permission: "website.view", icon: Globe, devOnly: true },
