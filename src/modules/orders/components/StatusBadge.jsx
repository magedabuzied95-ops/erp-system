...
const statusClasses = {
  ...
  "Shipment Created": "border-primary/25 bg-primary/10 text-primary",
  "Picked Up": "border-primary/25 bg-primary/10 text-primary",
  "In Transit": "border-primary/25 bg-primary/10 text-primary",
  "Out For Delivery": "border-primary/25 bg-primary/10 text-primary",
