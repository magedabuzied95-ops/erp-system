      ...
      {receiptCoupon?.code ? (
        <section className="thermal-coupon">
          ...
          {Array.isArray(receiptCoupon.terms) && receiptCoupon.terms.length ? (
            <ul className="thermal-coupon-rules">
              {receiptCoupon.terms.map((line, index) => <li key={index}>{line}</li>)}
            </ul>
          ) : null}
        </section>
      ) : null}
