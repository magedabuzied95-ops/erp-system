...
export function StoryCTA({ story, template, product, campaign }) {
  ...
  return (
    <motion.a
      ...
      className={`relative flex min-h-14 min-w-[154px] items-center justify-center overflow-hidden rounded-full px-8 py-4 text-center text-[17px] font-black shadow-2xl ring-1 ring-white/25 ${accentClasses[template.accent] || accentClasses.cyan}`}
