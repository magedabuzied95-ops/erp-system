      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div className="flex shrink-0 flex-wrap gap-2">
          ...
          <button
            type="button"
            onClick={clear}
            className="inline-flex h-9 items-center gap-2 rounded-xl border border-rose-300/15 bg-rose-400/10 px-3 text-xs font-black text-rose-100 transition hover:bg-rose-400/15"
          >
