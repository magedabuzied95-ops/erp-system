...
export function loadConfig(env = process.env) {
  ...
  return Object.freeze({
    ...
    expectedUsername: String(env.INSTAGRAM_EXPECTED_USERNAME || 'm.one.store.pro').trim().replace(/^@/, '').toLowerCase(),
...
export function assertSafePilotConfig(config) {
  ...
  if (!config.expectedUsername) violations.push('expected_test_username_required');
