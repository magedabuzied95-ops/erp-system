...
CREATE TABLE IF NOT EXISTS products (
  ...
  thermal_image_generated_at TIMESTAMPTZ NULL,
  thermal_image_error TEXT DEFAULT '',
...
CREATE TABLE IF NOT EXISTS product_variants (
  ...
  low_stock_alert INTEGER NOT NULL DEFAULT 0,
  purchase_pack_type VARCHAR(20) NOT NULL DEFAULT 'unit',
  purchase_pack_qty INTEGER NOT NULL DEFAULT 1,
  reorder_trigger_percent NUMERIC(6,2) NOT NULL DEFAULT 70,
  size_distribution_json JSONB NULL,
  supplier_id BIGINT NULL,
  last_purchase_cost NUMERIC(12,2) NULL,
  is_active BOOLEAN NOT NULL DEFAULT TRUE,
...
CREATE INDEX IF NOT EXISTS idx_inventory_count_items_inventory_count_id ON inventory_count_items (inventory_count_id);
  ...
  CREATE TABLE IF NOT EXISTS customers (
    ...
    loyalty_updated_at TIMESTAMPTZ NULL,
    status VARCHAR(50) NOT NULL DEFAULT 'active',
    created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP
  );
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  cancel_reason TEXT,
  stock_reverted_at TIMESTAMPTZ NULL,
  ...
  shipping_last_synced_at TIMESTAMPTZ NULL,
  ...
  last_shipping_sync_at TIMESTAMPTZ NULL,
...
ALTER TABLE IF EXISTS ai_support_sessions
  ...
  ADD COLUMN IF NOT EXISTS auto_favorite_order_id BIGINT NULL,
  ...
  ADD COLUMN IF NOT EXISTS last_ai_reply_draft_updated_at TIMESTAMPTZ NULL;
